...
var valueLine = d3.line()
  ...
  .y(function (d) { return y(+d.ConsumptionValue); })

// Create the svg canvas in the "graph" div
var renewableSVG = d3.select("#graph")
  .append("svg")
...
// Import the CSV data
d3.csv("renewableenergydata.csv", function (error, data) {
  ...
  y.domain([0, d3.max(data, function (d) { return d.ConsumptionValue; })]);

  // Set up the x axis
  var xaxis = renewableSVG.append("g")
  ...
  // Create 1st dropdown
  var ConsumptionTypeMenu = d3.select("#ConsumptionTypeDropdown")
  ...
  var initialGraph = function (ConsumptionType) {
    ...
    var selectConsumptionTypeGroups = renewableSVG.selectAll(".ConsumptionTypeGroups")
    ...
    // Add the Y Axis
    var yaxis1 = renewableSVG.append("g")
      .attr("class", "y axis")
      .call(d3.axisLeft(y)
        .ticks(10));
  ...
  initialGraph("Consumption.Commercial.Geothermal")
  ...
  ConsumptionTypeMenu.on('change', function () {
